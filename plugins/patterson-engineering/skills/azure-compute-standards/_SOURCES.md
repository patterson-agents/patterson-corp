# Sources — Azure Compute Standards
...
| Article | **Azure Compute Standards** |
| `sys_kb_id` | `937eb90b3b650f107f43b50236e45a16` |
| URL | <https://patterson.service-now.com/esc?id=kb_article_view&sys_kb_id=937eb90b3b650f107f43b50236e45a16> |
| Owner | Infra CloudOps |
| Retrieved | 2026-08-11 |

> [!IMPORTANT]
> Where the standard is silent, the text says `[TBD: not specified in the Azure Compute Standards standard]` rather than
> filling the gap.
