# Sources — Storage & Data Standards
...
| Article | **Storage & Data Standards** |
| `sys_kb_id` | `fdc09a4d93548f908037f8bd1dba10ed` |
| URL | <https://patterson.service-now.com/esc?id=kb_article_view&sys_kb_id=fdc09a4d93548f908037f8bd1dba10ed> |
| Owner | Infra CloudOps |
| Retrieved | 2026-08-11 |

> [!IMPORTANT]
> Where the standard is silent, the text says `[TBD: not specified in the Storage & Data Standards standard]` rather than
> filling the gap.
