# References — Azure Environment Standards
...
**Azure Environment Standards** — ServiceNow IT Standards & Guidelines. Owner: Infra CloudOps.

<https://patterson.service-now.com/esc?id=kb_article_view&sys_kb_id=a507920d2b25c7941f16fc8bee91bfc4>
...
Detailed clause text lives in `references/` next to this file.

> [!TIP]
> [`SKILL.md`](SKILL.md) carries only the decision rules. Load a reference file when you need the
> full wording of a clause in order to cite it.
