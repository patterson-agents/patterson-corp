# Sources — Azure Environment Standards
...
| Article | **Azure Environment Standards** |
| `sys_kb_id` | `a507920d2b25c7941f16fc8bee91bfc4` |
| URL | <https://patterson.service-now.com/esc?id=kb_article_view&sys_kb_id=a507920d2b25c7941f16fc8bee91bfc4> |
| Owner | Infra CloudOps |
| Retrieved | 2026-08-11 |

> [!IMPORTANT]
> Where the standard is silent, the text says `[TBD: not specified in the Azure Environment Standards standard]` rather than
> filling the gap.
