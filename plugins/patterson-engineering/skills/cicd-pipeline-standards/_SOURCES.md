# Sources — CI/CD Pipeline Standards
...
| Article | **CI/CD Pipeline Standards** |
| `sys_kb_id` | `c70e79833b650f107f43b50236e45a7d` |
| URL | <https://patterson.service-now.com/esc?id=kb_article_view&sys_kb_id=c70e79833b650f107f43b50236e45a7d> |
| Owner | Infra CloudOps |
| Retrieved | 2026-08-11 |

> [!IMPORTANT]
> Where the standard is silent, the text says `[TBD: not specified in the CI/CD Pipeline Standards standard]` rather than
> filling the gap.
